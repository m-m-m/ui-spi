...
/**
 * Implementation of {@link WritableRange} for {@link io.github.mmm.ui.api.widget.number.UiNumericInput}.
 *
 * @param <V> type of the contained values.
 * @since 1.0.0
 * @see io.github.mmm.ui.api.widget.number.UiNumericInput#getRange()
 */
