...
image:https://img.shields.io/github/license/m-m-m/ui-spi.svg?label=License["Apache License, Version 2.0",link=https://github.com/m-m-m/ui-spi/blob/main/LICENSE]
...
image:https://javadoc.io/badge2/io.github.m-m-m/mmm-ui-spi-core/javadoc.svg["JavaDoc",link=https://javadoc.io/doc/io.github.m-m-m/mmm-ui-spi-core]
